...
- My kinnie: ┆ Sunday (HSR) ┆ Phainon (HSR) ┆ Flins (GI) ┆ Karkat (HS) ┆ Gaara (Naruto) ┆ Yashiro Nene (JSH-k) ┆ Yuji Itadori (JK) ┆ Shinji Ikari (Evangelion) ┆ Nana Osaki (NANA) ┆ Aki Hayakawa (CM) ┆ Ryker Dublin (8:11) ┆ Jinx (Arcane) ┆  <br>
